...
<body>
<div align="center" class="style4">Registered Customers</div>
<%@ include file="db.jsp" %>
<% 
...
<table width="929" border="1" align="center">
  <tr bgcolor="#FFFFFF">
    <td width="146"><span class="style3">Name</span></td>
    <td width="69"><span class="style3">Address </span></td>
    <td width="65"><span class="style3">Phone</span></td>
...
try{
int x=stmt.executeUpdate("update orders set status='Delivered' where productname='"+itemname+"' and customerid='"+customerid+"' and status='ordered' and storephone='"+session.getAttribute("rid")+"'");
if(x!=0){
%>
