...
rst=stmt.executeQuery("select productname,productprice,image,description,productid from specialproduct where  productname like '%"+pname+"%'  ");
while(rst.next()){
...
<table width="537" border="1" align="center">
  ...
  <tr>
    <td><div align="center">
      ...
      <a href="buyspecial.jsp?p=<%= rst.getString(1) %>" >Buy</a><br />
        </p>
    </div> </td>
  </tr>
</table>
...
rst=stmt.executeQuery("select productname,productprice,image,description,productid from specialproduct   ");
while(rst.next()){
